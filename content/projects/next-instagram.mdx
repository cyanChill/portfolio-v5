...
> Reference to this can be found in one of Next.js' [examples on GitHub](https://github.com/vercel/next.js/blob/canary/examples/with-mongodb-mongoose/lib/dbConnect.js)
